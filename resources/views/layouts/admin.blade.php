    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <div class="text-center">
                <a href="" class="logo">Digital<i class="icon-c-logo"></i><span><i class="md md-a"></i>Capital</span></a>
            </div>
        </div>
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li class="has_sub">
                            ...
                            <a href="{{route('admin_careers.index')}}" class="waves-effect"><i class="fa fa-phone"></i> <span> Careers </span></a>
                            <a href="{{route('admin_jobs.index')}}" class="waves-effect"><i class="fa fa-pencil"></i> <span> Jobs </span></a>
                            <a href="{{route('candidates.index')}}" class="waves-effect"><i class="fa fa-home"></i> <span> Candidates </span></a>
...
{{--                        <a href="{{route('blog.index')}}" class="waves-effect"><i class="fa fa-file"></i> <span>Blog</span></a>--}}
    ...
    <div class="content-page">
        ...
        <footer class="footer text-right">
            DigitalCapital &copy; 2020 All rights reserved.
        </footer>
    </div>
    <!-- ============================================================== -->
