    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-md-4">
                ...
                @endif
                {!! Form::model(Auth::user(),['method'=>'PATCH','action'=>['AdminUserController@update',Auth::id()],'files'=>true]) !!}
                {{--                        img< src="{{asset('admin_assets/images/logo1.png')}}" class="img-responsive" alt="logo" style=" display: table; margin-bottom: 17px;" />--}}
                <div class="form-group">
                    <label > Admin Name: </label>
                    <input type="text" name="name" value="{{Auth::user()->name}}" class="form-control" placeholder="User Name">
                    @if ($errors->has('name'))
                ...
                <div class="form-group">
                    <label > E-mail </label>
                    <input type="email" name="email" value="{{Auth::user()->email}}" class="form-control" placeholder="E-mail Address">
                    @if ($errors->has('email'))
